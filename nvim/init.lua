...
m("v", "<leader>d", "<c-[>:bd!<cr>1<c-g>", silent)
m("n", "<leader>q", ":qall!<cr>", silent)
m("v", "<leader>q", "<c-[>:qall!<cr>", silent)
m("n", "<leader>w", ":call v:lua.remove_whitespace()<cr>", silent)
m("v", "<leader>w", "<c-[>:call v:lua.remove_whitespace()<cr>", silent)
m("n", "<leader>r", [[:call v:lua.format_and_write()<cr>]], silent)
m("v", "<leader>r", [[<c-[>:call v:lua.format_and_write()<cr>]], silent)
m("n", "Y", "y$", opt)
m("n", 'y"', 'yi"', opt)
m("n", "y'", "yi'", opt)
m("n", "D", "d$", opt)
