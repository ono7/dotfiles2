...
if s:configuration.transparent_background
  ...
  call gruvbox_material#highlight('Folded', s:palette.grey1, s:palette.none) call gruvbox_material#highlight('SignColumn', s:palette.fg0, s:palette.none) call gruvbox_material#highlight('ToolbarLine', s:palette.fg0, s:palette.none)
else
...
hi!  RedItalic      cterm=italic  gui=italic  ctermfg=167  guifg=#ea6962
hi!  OrangeItalic   cterm=italic  gui=italic  ctermfg=208  guifg=#e78a4e
hi!  YellowItalic   cterm=italic  gui=italic  ctermfg=214  guifg=#d8a657
hi!  GreenItalic    cterm=italic  gui=italic  ctermfg=142  guifg=#a9b665
hi!  AquaItalic     cterm=italic  gui=italic  ctermfg=108  guifg=#89b482
hi!  BlueItalic     cterm=italic  gui=italic  ctermfg=109  guifg=#7daea3
hi!  PurpleItalic   cterm=italic  gui=italic  ctermfg=175  guifg=#d3869b
hi!  NormalItalic   cterm=italic  gui=italic  ctermfg=223  guifg=#d4be98
hi!  CommentItalic  cterm=italic  gui=italic  ctermfg=245  guifg=#928374
hi!  RedBold        cterm=bold    gui=bold    ctermfg=167  guifg=#ea6962
hi!  OrangeBold     cterm=bold    gui=bold    ctermfg=208  guifg=#e78a4e
hi!  YellowBold     cterm=bold    gui=bold    ctermfg=214  guifg=#d8a657
hi!  GreenBold      cterm=bold    gui=bold    ctermfg=142  guifg=#a9b665
hi!  AquaBold       cterm=bold    gui=bold    ctermfg=108  guifg=#89b482
hi!  BlueBold       cterm=bold    gui=bold    ctermfg=109  guifg=#7daea3
hi!  PurpleBold     cterm=bold    gui=bold    ctermfg=175  guifg=#d3869b
hi!  NormalBold     cterm=bold    gui=bold    ctermfg=223  guifg=#d4be98
hi!  CommentBold    cterm=bold    gui=bold    ctermfg=245  guifg=#928374

" number colors
hi!  CursorLineNr   ctermfg=246  ctermbg=NONE   guifg=#a89984  guibg=NONE
hi!  Folded         ctermfg=245  ctermbg=NONE   guifg=#928374  guibg=NONE
hi!  Cursor         gui=NONE     cterm=NONE     ctermbg=208    ctermfg=167    guifg=#1d2021  guibg=#e78a4e
hi!  MsgArea        ctermfg=246  ctermbg=NONE   guifg=#a89984  guibg=NONE
hi!  pMenu          ctermbg=235  guibg=#262727  ctermfg=246    guifg=#a89984
hi!  CommentNormal  ctermfg=245  guifg=#928374
hi!  Visual         ctermfg=234  ctermbg=142    guifg=#1d2021  guibg=#a9b665

" gutter
hi! SignColumn ctermfg=223 ctermbg=235 guifg=#d4be98 guibg=#1d2021
hi! RedSign ctermfg=167 ctermbg=NONE guifg=#ea6962 guibg=NONE
hi! YellowSign ctermfg=214 ctermbg=NONE guifg=#d8a657 guibg=NONE
hi! BlueSign ctermfg=109 ctermbg=NONE guifg=#7daea3 guibg=NONE
