...
M.setup = function()
  ...
  -- -- Functions
  M.highlight("TSFuncBuiltin", {fg = M.colors.yellow, gui = "bold"})
  ...
  M.highlight("TSKeywordOperator", {fg = M.colors.purple})
  M.highlight("TSOperator", {fg = M.colors.white})
  ...
  -- -- Variable
  M.highlight("TSVariable", {fg = M.colors.cyan})
