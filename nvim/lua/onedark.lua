...
M.setup = function()
  ...
  M.highlight("Number", {fg = M.colors.orange})
  ...
  M.highlight("Repeat", {fg = M.colors.purple, gui = "italic"})
  M.highlight("Label", {fg = M.colors.purple})
  M.highlight("Operator", {fg = M.colors.purple, gui = "italic"})
  ...
  M.highlight("Whitespace", {fg = M.colors.light_grey})
  ...
  M.highlight("myCurlys", {fg = M.colors.orange})
