...
M.setup = function()
  ...
  M.highlight("Conditional", {fg = M.colors.red, gui = "italic"})
  M.highlight("Repeat", {fg = M.colors.purple})
  M.highlight("Label", {fg = M.colors.purple})
  M.highlight("Operator", {fg = M.colors.blue})
  ...
  M.highlight("markdownH2", {fg = M.colors.orange, gui = "bold,italic"})
  M.highlight("markdownH3", {fg = M.colors.yellow, gui = "bold,italic"})
  M.highlight("markdownH4", {fg = M.colors.red, gui = "bold,italic"})
  M.highlight("markdownH5", {fg = M.colors.cyan, gui = "bold,italic"})
  ...
  -- M.highlight("TSLabel", {})
  M.highlight("TSKeyword", {fg = M.colors.purple, gui = "bold,italic"})
  M.highlight("TSKeywordFunction", {fg = M.colors.red, gui = "italic,bold"})
  M.highlight("TSKeywordOperator", {fg = M.colors.purple, gui = "italic"})
  M.highlight("TSOperator", {fg = M.colors.purple, gui = "bold"})
