...
brew install ansifilter wget tree go neovim rar clang-format kitty zoxide wezterm
brew install fd cmake ack rg coreutils ssh-copy-id jq p7zip kitty curl tmux universal-ctags mtr lua ninja rust npm starship 
brew install bpytop
